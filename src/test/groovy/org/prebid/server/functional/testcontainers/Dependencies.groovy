...
class Dependencies {
    ...
    private static final Boolean IS_LAUNCH_CONTAINERS = Boolean.valueOf(getValueOfDef("launchContainers", "true"))

    static final ObjectMapperWrapper objectMapperWrapper = new ObjectMapperWrapper()

    static final Network network = Network.newNetwork()

    static String getValueOfDef(String property, String defaultValue) {
