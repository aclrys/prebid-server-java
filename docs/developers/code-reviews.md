...
## Standards
Anyone is free to review and comment on any [open pull requests](https://github.com/aclrys/prebid-server-java/pulls).
...
- Is the motivation behind these changes clear? If not, there must be [an issue](https://github.com/aclrys/prebid-server-java/issues) 
